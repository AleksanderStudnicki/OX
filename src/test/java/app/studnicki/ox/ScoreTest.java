...
public class ScoreTest {
    ...
    /**
     * Score class has addWin() method that adds 3 to value of the score after each win by a player.
     * So after the first win, when player had 0 points at the beginning, it should return 3 as a value of the score.
